// Source code. We are not using it.
  ...
  function f() {
    return n(this, void 0, void 0, function () {
      ...
      return o(this, function (t) {
        return navigator.credentials.conditionalMediationSupported
          ? [2, !0]
          : [
              2,
              void 0 !==
                (e = window.PublicKeyCredential)
          ...
          return o(this, function (o) {
            switch (o.label) {
              case 0:
                ...
                return (
                  0 !==
                    (null === (p = e.allowCredentials) || void 0 === p
                      ? void 0
                      : p.length) &&
                    (n =
                      null === (h = e.allowCredentials) || void 0 === h
                        ? void 0
                        : h.map(u)),
                  (w = r(r({}, e), {
              ...
              case 3:
                return (
                  o.trys.push([3, 5, 6, 7]), [4, navigator.credentials.get(b)]
                );
              case 4:
                return (y = o.sent()), [3, 7];
              case 5:
                throw (function (e) {
                  ...
                  if (!o)
                    throw Error(
                      'options was missing required publicKey property'
                    );
                  if ('AbortError' === r.name) {
                    ...
                    if ('NotAllowedError' === r.name)
                      return (
                        null === (t = o.allowCredentials) || void 0 === t
                          ? void 0
                          : t.length
                      )
                        ? new c(
          ...
          switch (o.label) {
            case 0:
              ...
              (t = r(r({}, e), {
                challenge: a(e.challenge),
                user: r(r({}, e.user), {
                  id: ((v = e.user.id), new TextEncoder().encode(v)),
                }),
            ...
            case 1:
              return (
                o.trys.push([1, 3, 4, 5]), [4, navigator.credentials.create(n)]
              );
            case 2:
              return (f = o.sent()), [3, 5];
            case 3:
              throw (function (e) {
                ...
                if ('AbortError' === n.name) {
                  ...
                  if (
                    !0 ===
                    (null === (t = i.authenticatorSelection) || void 0 === t
                      ? void 0
                      : t.requireResidentKey)
                  )
                    return new c(
            ...
            case 5:
              ...
              return (
                ...
                'function' == typeof w.getTransports &&
                  (y.transports = w.getTransports()),
                [2, y]
              );
          }
          var v;
